...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EffectiveScheduleStatus) DeepCopyInto(out *EffectiveScheduleStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EffectiveScheduleStatus.
func (in *EffectiveScheduleStatus) DeepCopy() *EffectiveScheduleStatus {
	if in == nil {
		return nil
	}
	out := new(EffectiveScheduleStatus)
	in.DeepCopyInto(out)
	return out
}
